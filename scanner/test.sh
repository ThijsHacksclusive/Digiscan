...
launch_cmd() {
    ...
    case "$OS" in
        wsl)
            case $scan_type in 
                1) 
                    wt.exe --window last new-tab bash -ic "cd /mnt/c/Users/theer/Documents/Stage/scanner/scans && echo $website_url && bash ./testssl_scans.sh $website_url" &
                    wt.exe --window last new-tab bash -ic "cd /mnt/c/Users/theer/Documents/Stage/scanner/scans && echo $website_url && bash ./HTTP_method_scanner.sh $website_url && read -p 'press enter to quit'" &
                    wt.exe --window last new-tab bash -ic "cd /mnt/c/Users/theer/Documents/Stage/scanner/scans && echo $website_url && bash ./portscan.sh $website_url"
                    ;;
                2)
                ...
                3)
                    ...
                    ;;
                4)
                    wt.exe --window last new-tab bash -ic "cd /mnt/c/Users/theer/Documents/Stage/scanner/scans && echo $website_url && bash ./portscan.sh $website_url && read -p 'press enter to quit'"
                    ;;
                5)
                    #wt.exe --window last new-tab bash -ic "cd /mnt/c/Users/theer/Documents/Stage/scanner/scans && echo $website_url && bash ./ffuf_scan.sh $website_url && read -p 'press enter to quit'" &
                    #wt.exe --window last new-tab bash -ic "cd /mnt/c/Users/theer/Documents/Stage/scanner/scans && echo $website_url && bash ./webanalyse.sh $website_url && read -p 'press enter to quit'"
                    ;;
                6)
                    wt.exe --window last new-tab bash -ic "cd /mnt/c/Users/theer/Documents/Stage/scanner/scans/testssl_eisen && bash ./csv_editor.sh && read -p 'press enter to quit'"
                    ;;
                *)
